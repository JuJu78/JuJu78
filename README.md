...
## 🌐 Mes projets phares
- [AI Search Intent](https://julien-gourdon.fr/tools/ai-search-intent) : Analyse sémantique approfondie des résultats de recherche de Google sur des mots-clés cibles et MCP intégrée pour générer des article SEO de grande qualité
- [MCP Wiki](https://julien-gourdon.fr/mcp/mcp-wiki) : Explorez les entités Wikidata, résolvez des termes en batch et générez des scripts JSON-LD structurés liés au web sémantique, directement depuis ChatGPT, Claude ou toute plateforme IA compatible client MCP.
- [GPTGeo](https://julien-gourdon.fr/tools/gptgeo) : Stockez automatiquement les réponses de ChatGPT dans un Google Sheet partagé pour suivre gratuitement votre visibilité et celle de vos concurrents au fil du temps.
